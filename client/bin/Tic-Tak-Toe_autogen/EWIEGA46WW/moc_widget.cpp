...
Q_CONSTINIT static const qt_meta_stringdata_CLASSWidgetENDCLASS_t qt_meta_stringdata_CLASSWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 18),  // "SendToServerSignal"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 3),  // "arr"
        QT_MOC_LITERAL(31, 7)   // "SetText"
    },
    "Widget",
    "SendToServerSignal",
    "",
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Widget::*)(const QByteArray & );
            if (_t _q_method = &Widget::SendToServerSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Widget::SendToServerSignal(const QByteArray & _t1)
{
