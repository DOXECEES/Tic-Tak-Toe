...
Q_CONSTINIT static const qt_meta_stringdata_CLASSConnectionDialogENDCLASS_t qt_meta_stringdata_CLASSConnectionDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 18),  // "SendToServerSignal"
        QT_MOC_LITERAL(36, 0),  // ""
        QT_MOC_LITERAL(37, 3),  // "arr"
        QT_MOC_LITERAL(41, 8)   // "SendSlot"
    },
    "ConnectionDialog",
    "SendToServerSignal",
    "",
...
void ConnectionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ConnectionDialog::*)(const QByteArray & );
            if (_t _q_method = &ConnectionDialog::SendToServerSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConnectionDialog::SendToServerSignal(const QByteArray & _t1)
{
