...
Q_CONSTINIT static const qt_meta_stringdata_CLASSProfileENDCLASS_t qt_meta_stringdata_CLASSProfileENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 18),  // "SendToServerSignal"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 3)   // "arr"
    },
    "Profile",
    "SendToServerSignal",
    "",
...
void Profile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Profile::*)(const QByteArray & );
            if (_t _q_method = &Profile::SendToServerSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Profile::SendToServerSignal(const QByteArray & _t1)
{
